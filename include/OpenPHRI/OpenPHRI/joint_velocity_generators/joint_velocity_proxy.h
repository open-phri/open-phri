...
public:
    ...
    explicit JointVelocityProxy(vector::dyn::Velocity& velocity);

    //! \brief Construct a new JointVelocityProxy object forwarding the given
    //! value
    //! \param velocity The velocity to forward
    explicit JointVelocityProxy(const vector::dyn::Velocity& velocity);
    ...
    vector::dyn::Velocity velocity() const;
