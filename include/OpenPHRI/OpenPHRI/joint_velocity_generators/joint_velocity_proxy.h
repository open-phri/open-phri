...
public:
    using generator = std::function<VectorXd(void)>;
    ...
    explicit JointVelocityProxy(std::shared_ptr<VectorXd> velocity);

    //! \brief Construct a new JointVelocityProxy object forwarding the given
    //! referenced value
    //! \param velocity The velocity to forward. Make sure that \p velocity
    //! outlives the generator
    explicit JointVelocityProxy(VectorXd& velocity);

    //! \brief Construct a new JointVelocityProxy object forwarding the given
    //! value
    //! \param velocity The velocity to forward
    explicit JointVelocityProxy(const VectorXd& velocity);
