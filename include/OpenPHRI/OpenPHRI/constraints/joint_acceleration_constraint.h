...
public:
	...
	/**
	 * @brief Construct an acceleration constraint with a given maximum acceleration.
...
using JointAccelerationConstraintPtr = std::shared_ptr<JointAccelerationConstraint>;
using JointAccelerationConstraintConstPtr = std::shared_ptr<const JointAccelerationConstraint>;
