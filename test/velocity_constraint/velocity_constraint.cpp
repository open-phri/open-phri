...
int main(int argc, char const *argv[]) {
	...
	assert_msg("Step #3", isClose(robot->controlPointVelocity()->translation().norm(), *maximum_velocity));
	...
	assert_msg("Step #5", isClose(robot->controlPointVelocity()->translation().norm(), *maximum_velocity));
