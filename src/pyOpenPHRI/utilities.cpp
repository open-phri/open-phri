...
// BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(Integrator_force_overloads, force, 1, 1)


template<typename T>
std::shared_ptr<Derivator<T>> NewDerivator(std::shared_ptr<const T> input, double sample_time)
{
...
#define CREATE_INTEGRATOR(type) \
	...
	void (Integrator< type >:: *force_ptr_##type)(std::shared_ptr<const type >)       = &Integrator<type>::force; \
...
void wrapUtilities() {
	...
	/*********************************************************************************/
	def("NewIntegrator",    NewIntegrator<double>,      "Create a new instance of a Integrator shared_ptr");
	def("NewIntegrator",    NewIntegrator<Vector2d>,    "Create a new instance of a Integrator shared_ptr");
	def("NewIntegrator",    NewIntegrator<Vector3d>,    "Create a new instance of a Integrator shared_ptr");
	def("NewIntegrator",    NewIntegrator<Vector6d>,    "Create a new instance of a Integrator shared_ptr");

	def("NewDerivator",     NewDerivator<double>,       "Create a new instance of a Derivator shared_ptr");
	def("NewDerivator",     NewDerivator<Vector2d>,     "Create a new instance of a Derivator shared_ptr");
	def("NewDerivator",     NewDerivator<Vector3d>,     "Create a new instance of a Derivator shared_ptr");
	def("NewDerivator",     NewDerivator<Vector6d>,     "Create a new instance of a Derivator shared_ptr");
